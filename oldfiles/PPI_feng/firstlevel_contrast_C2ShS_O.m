...
for i=1:nsub
    ...
    %  analysis directory
    stats_suffix='\PPI\PPI_rAI_C2_Sh_S-O';
    ...
    cname{1} = 'rAI_C2_Sh_S-O';            %Step4: last step, add contrast!!!{'wingood','lossgood', 'winbad','lossbad'};
    cons{1} = [1 0 0 mov 1 0 0 mov 1 0 0 mov mns]; % 3nrun nconstants %%%%%%%
    ctype{1} ='T';  % contrast type
%     cname{2} = '-rAI_C2_Sh_S-O';            %Step4: last step, add contrast!!!{'wingood','lossgood', 'winbad','lossbad'};
