...
for subn=1:length(SubList)
    ...
    res_path=fullfile(func_path,SubList(subn).name,'/PPI/PPI_rAI_C3_Sh_S-O')
    if ~exist(res_path)
        mkdir(res_path);
    end
    ...
    PPI_file1 = [res_path,'/PPI_PPI_rAI_C3_Sh_S-O1.mat'];
    PPI_file2 = [res_path,'/PPI_PPI_rAI_C3_Sh_S-O2.mat'];
    PPI_file3 = [res_path,'/PPI_PPI_rAI_C3_Sh_S-O3.mat'];
