...
for subn=1:length(SubList)
    ...
    res_path=fullfile(func_path,SubList(subn).name,'PPI',PPIName)
    if ~exist(res_path)
    ...
    PPI_file1 = fullfile(res_path,['PPI_' PPIName '1.mat']);
    PPI_file2 = fullfile(res_path,['PPI_' PPIName '2.mat']);
    PPI_file3 = fullfile(res_path,['PPI_' PPIName '3.mat']);
