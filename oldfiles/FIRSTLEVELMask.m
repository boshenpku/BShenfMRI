function [CntrP, regr] = FIRSTLEVEL(onset,CondList,DursCond,Parametric_under_condition,...
    Nuisance,DursNuisance,Parametric_under_nuisance,derivs,...
    TR,NSlice,Microt0,imgdir,subfold_img,SessFold_img,imghead,firstleveldir)
...
matlabbatch{1}.spm.stats.fmri_spec.mask = {which('rMask_withoutCerebelum.nii')};
