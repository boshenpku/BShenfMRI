clear;clc;
ROIs={
    'E:\ShenBo\GR\Model\SecondLevel\FFMixedContrast\BinaryMask_U1lSMG.nii'
    'E:\ShenBo\GR\Model\SecondLevel\FFMixedContrast\BinaryMask_U2precunues.nii'
    'E:\ShenBo\GR\Model\SecondLevel\FFMixedContrast\BinaryMask_U3rAngular.nii'
    };
ROIname={'lSMG' 'Precunues' 'rAngular'};
for i=1:length(ROIs)
    V = spm_vol(ROIs{i});
...
for subj=1:length(subjlist)
    ...
    save(fullfile(tCoursedir,'tCourse'),'shc1sw','shc2sw','shc3sw','shc1ow','shc2ow','shc3ow');
    % combine subject
    for agent = {'sw' 'ow'}
        for context = {'shc1' 'shc2' 'shc3'}
...
for i=1:length(ROIs)
    ...
    legend('shc1sw','shc2sw','shc3sw','shc1ow','shc2ow','shc3ow','Location','NorthWest');
